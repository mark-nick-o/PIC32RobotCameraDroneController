#ifndef __command_long_mavlink2__
#define __command_long_mavlink2__
...
#if defined(D_FT900)
typedef struct __mavlink_command_long_t MAVPACKED {
 float32_t param1;                                                              /*<  Parameter 1 (for the specific command).*/
 float32_t param2;                                                              /*<  Parameter 2 (for the specific command).*/
 float32_t param3;                                                              /*<  Parameter 3 (for the specific command).*/
 float32_t param4;                                                              /*<  Parameter 4 (for the specific command).*/
 float32_t param5;                                                              /*<  Parameter 5 (for the specific command).*/
 float32_t param6;                                                              /*<  Parameter 6 (for the specific command).*/
 float32_t param7;                                                              /*<  Parameter 7 (for the specific command).*/
...
#define MAVLINK_MSG_ID_COMMAND_LONG_MIN_LEN 33u
#define MAVLINK_MSG_ID_76_LEN 33u
#define MAVLINK_MSG_ID_76_MIN_LEN 33u

#define MAVLINK_MSG_ID_COMMAND_LONG_CRC 152u
#define MAVLINK_MSG_ID_76_CRC 152u
...
static inline uint16_t mavlink_msg_command_long_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target_system, uint8_t target_component, uint16_t command, uint8_t confirmation, float32_t param1, float32_t param2, float32_t param3, float32_t param4, float32_t param5, float32_t param6, float32_t param7)
{
 ...
 */
static inline void mavlink_msg_command_long_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, uint16_t command, uint8_t confirmation, float32_t param1, float32_t param2, float32_t param3, float32_t param4, float32_t param5, float32_t param6, float32_t param7)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
{
    return _MAV_RETURN_float32_t(msg,  0);
}
...
static inline void mavlink_msg_command_long_decode(const mavlink_message_t* msg, mavlink_command_long_t* command_long)
{
    ...
    memcpy((void*)command_long,(void*) _MAV_PAYLOAD(msg),(int16_t) len);
#endif
}
