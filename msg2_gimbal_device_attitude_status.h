#ifndef __gimbal_report_attitude_mavlink2__
#define __gimbal_report_attitude_mavlink2__
...
#define MAVLINK_MSG_ID_GIMBAL_DEVICE_ATTITUDE_STATUS 285u

#if defined(D_FT900)
typedef struct MAVPACKED {
 uint32_t time_boot_ms;                                                         /*< [ms] Timestamp (time since system boot).*/
 float32_t q[4u];                                                               /*<  Quaternion components, w, x, y, z (1 0 0 0 is the null-rotation, the frame is depends on whether the flag GIMBAL_DEVICE_FLAGS_YAW_LOCK is set)*/
 float32_t angular_velocity_x;                                                  /*< [rad/s] X component of angular velocity (NaN if unknown)*/
 float32_t angular_velocity_y;                                                  /*< [rad/s] Y component of angular velocity (NaN if unknown)*/
 float32_t angular_velocity_z;                                                  /*< [rad/s] Z component of angular velocity (NaN if unknown)*/
...
#define MAVLINK_MSG_ID_GIMBAL_DEVICE_ATTITUDE_STATUS_LEN 38u
#define MAVLINK_MSG_ID_GIMBAL_DEVICE_ATTITUDE_STATUS_MIN_LEN 38u
#define MAVLINK_MSG_ID_285_LEN 38u
#define MAVLINK_MSG_ID_285_MIN_LEN 38u

#define MAVLINK_MSG_ID_GIMBAL_DEVICE_ATTITUDE_STATUS_CRC 82u
#define MAVLINK_MSG_ID_285_CRC 82u

#define MAVLINK_MSG_GIMBAL_DEVICE_ATTITUDE_STATUS_FIELD_Q_LEN 4u
 ...
 */
static inline uint16_t mavlink_msg_gimbal_device_attitude_status_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, uint32_t time_boot_ms, uint16_t flags, const float32_t *q, float32_t angular_velocity_x, float32_t angular_velocity_y, float32_t angular_velocity_z, uint32_t failure_flags)
{
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_gimbal_device_attitude_status_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, uint32_t time_boot_ms, uint16_t flags, const float32_t *q, float32_t angular_velocity_x, float32_t angular_velocity_y, float32_t angular_velocity_z, uint32_t failure_flags)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_GIMBAL_DEVICE_ATTITUDE_STATUS_LEN];
    _mav_put_uint32_t(buf, 0, time_boot_ms);
...
static inline void mavlink_msg_gimbal_device_attitude_status_send(mavlink_channel_t chan, uint32_t time_boot_ms, uint16_t flags, const float32_t *q, float32_t angular_velocity_x, float32_t angular_velocity_y, float32_t angular_velocity_z, uint32_t failure_flags)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_GIMBAL_DEVICE_ATTITUDE_STATUS_LEN];
    _mav_put_uint32_t(buf, 0, time_boot_ms);
 ...
 */
static inline void mavlink_msg_gimbal_device_attitude_status_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_boot_ms, uint16_t flags, const float32_t *q, float32_t angular_velocity_x, float32_t angular_velocity_y, float32_t angular_velocity_z, uint32_t failure_flags)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline uint16_t mavlink_msg_gimbal_device_attitude_status_get_q(const mavlink_message_t* msg, float32_t *q)
{
    return _MAV_RETURN_float32_t_array(msg, q, 4,  4);
}
 ...
 */
static inline float32_t mavlink_msg_gimbal_device_attitude_status_get_angular_velocity_x(const mavlink_message_t* msg)
{
 ...
 */
static inline float32_t mavlink_msg_gimbal_device_attitude_status_get_angular_velocity_y(const mavlink_message_t* msg)
{
 ...
 */
static inline float32_t mavlink_msg_gimbal_device_attitude_status_get_angular_velocity_z(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_gimbal_device_attitude_status_decode(const mavlink_message_t* msg, mavlink_gimbal_device_attitude_status_t* gimbal_device_attitude_status)
{
    ...
    memcpy((void*)gimbal_device_attitude_status,(void*) _MAV_PAYLOAD(msg),(int16_t) len);
#endif
}
