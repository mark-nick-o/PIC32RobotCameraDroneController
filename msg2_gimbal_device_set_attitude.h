#ifndef __gimbal_set_attitude_mavlink2__
#define __gimbal_set_attitude_mavlink2__
...
#define MAVLINK_MSG_ID_GIMBAL_DEVICE_SET_ATTITUDE 284u

#if defined(D_FT900)
typedef struct MAVPACKED {
 float32_t q[4u];                                                               /*<  Quaternion components, w, x, y, z (1 0 0 0 is the null-rotation, the frame is depends on whether the flag GIMBAL_DEVICE_FLAGS_YAW_LOCK is set, set all fields to NaN if only angular velocity should be used)*/
 float32_t angular_velocity_x;                                                  /*< [rad/s] X component of angular velocity, positive is banking to the right, NaN to be ignored.*/
 float32_t angular_velocity_y;                                                  /*< [rad/s] Y component of angular velocity, positive is tilting up, NaN to be ignored.*/
 float32_t angular_velocity_z;                                                  /*< [rad/s] Z component of angular velocity, positive is panning to the right, NaN to be ignored.*/
...
#define MAVLINK_MSG_ID_GIMBAL_DEVICE_SET_ATTITUDE_LEN 32u
#define MAVLINK_MSG_ID_GIMBAL_DEVICE_SET_ATTITUDE_MIN_LEN 32u
#define MAVLINK_MSG_ID_284_LEN 32u
#define MAVLINK_MSG_ID_284_MIN_LEN 32u

#define MAVLINK_MSG_ID_GIMBAL_DEVICE_SET_ATTITUDE_CRC 99u
#define MAVLINK_MSG_ID_284_CRC 99u

#define MAVLINK_MSG_GIMBAL_DEVICE_SET_ATTITUDE_FIELD_Q_LEN 4u
 ...
 */
static inline uint16_t mavlink_msg_gimbal_device_set_attitude_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, uint8_t target_system, uint8_t target_component, uint16_t flags, const float *q, float32_t angular_velocity_x, float32_t angular_velocity_y, float32_t angular_velocity_z)
{
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_gimbal_device_set_attitude_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, uint8_t target_system,uint8_t target_component,uint16_t flags,const float *q,float32_t angular_velocity_x,float32_t angular_velocity_y,float32_t angular_velocity_z)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_GIMBAL_DEVICE_SET_ATTITUDE_LEN];
    _mav_put_float(buf, 16, angular_velocity_x);
...
static inline void mavlink_msg_gimbal_device_set_attitude_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint16_t flags, const float32_t *q, float32_t angular_velocity_x, float32_t angular_velocity_y, float32_t angular_velocity_z)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_GIMBAL_DEVICE_SET_ATTITUDE_LEN];
    _mav_put_float(buf, 16, angular_velocity_x);
 ...
 */
static inline void mavlink_msg_gimbal_device_set_attitude_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, uint16_t flags, const float32_t *q, float32_t angular_velocity_x, float32_t angular_velocity_y, float32_t angular_velocity_z)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline uint16_t mavlink_msg_gimbal_device_set_attitude_get_q(const mavlink_message_t* msg, float32_t *q)
{
    return _MAV_RETURN_float32_t_array(msg, q, 4,  0);
}
 ...
 */
static inline float32_t mavlink_msg_gimbal_device_set_attitude_get_angular_velocity_x(const mavlink_message_t* msg)
{
 ...
 */
static inline float32_t mavlink_msg_gimbal_device_set_attitude_get_angular_velocity_y(const mavlink_message_t* msg)
{
 ...
 */
static inline float32_t mavlink_msg_gimbal_device_set_attitude_get_angular_velocity_z(const mavlink_message_t* msg)
{
...
#else
    len = msg->len < MAVLINK_MSG_ID_GIMBAL_DEVICE_SET_ATTITUDE_LEN? msg->len : MAVLINK_MSG_ID_GIMBAL_DEVICE_SET_ATTITUDE_LEN;
    memset(gimbal_device_set_attitude, 0, MAVLINK_MSG_ID_GIMBAL_DEVICE_SET_ATTITUDE_LEN);
    memcpy((void*)gimbal_device_set_attitude,(void*) _MAV_PAYLOAD(msg),(int16_t) len);
#endif
}
