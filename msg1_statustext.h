#ifndef __mav1_statustext__
#define __mav1_statustext__
...
#if defined(D_FT900)
typedef struct __mavlink_statustext_t MAVPACKED {
...
typedef struct __mavlink_statustext_t {
 uint8_t severity;                                                              /*<  Severity of status. Relies on the definitions within RFC-5424.*/
 char text[50u];                                                                /*<  Status text message, without null termination character*/
}) mavlink_statustext_t;
#endif

#define MAVLINK_MSG_ID_STATUSTEXT_LEN 51u
#define MAVLINK_MSG_ID_STATUSTEXT_MIN_LEN 51u
#define MAVLINK_MSG_ID_253_LEN 51u
#define MAVLINK_MSG_ID_253_MIN_LEN 51u

#define MAVLINK_MSG_ID_STATUSTEXT_CRC 83u
#define MAVLINK_MSG_ID_253_CRC 83u

#define MAVLINK_MSG_STATUSTEXT_FIELD_TEXT_LEN 50u
...
static inline void mavlink_msg_statustext_decode(const mavlink_message_t* msg, mavlink_statustext_t* statustext)
{
    ...
    memcpy((void*)statustext,(void*)_MAV_PAYLOAD(msg), len);
#endif
}
