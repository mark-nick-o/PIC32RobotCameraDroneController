...
#ifndef __mavlink_cam_image_cap_status__
#define __mavlink_cam_image_cap_status__

#define MAVLINK_MSG_ID_CAMERA_IMAGE_CAPTURED 263u

#if defined(D_FT900)
typedef struct __mavlink_camera_image_captured_t MAVPACKED {
 ...
 float32_t q[4u];                                                               /*<  Quaternion of camera orientation (w, x, y, z order, zero-rotation is 0, 0, 0, 0)*/
 ...
 char file_url[205u];                                                           /*<  URL of image taken. Either local storage or http://foo.jpg if camera provides an HTTP interface.*/
...
{
    return _MAV_RETURN_uint64_t(msg,  0u);
}
...
{
    return _MAV_RETURN_uint8_t(msg,  48u);
}
...
{
    return _MAV_RETURN_int32_t(msg,  12u);
}
...
{
    return _MAV_RETURN_int32_t(msg,  16u);
}
...
{
    return _MAV_RETURN_int32_t(msg,  20u);
}
...
{
    return _MAV_RETURN_int32_t(msg,  24u);
}
...
{
    return _MAV_RETURN_float32_t_array(msg, q, 4u,  28u);
}
...
{
    return _MAV_RETURN_int32_t(msg,  44u);
}
...
{
    return _MAV_RETURN_int8_t(msg,  49u);
}
...
{
    return _MAV_RETURN_char_array(msg, file_url, 205u,  50u);
}
...
static inline void mavlink_msg_camera_image_captured_decode(const mavlink_message_t* msg, mavlink_camera_image_captured_t* camera_image_captured)
{
    ...
    memcpy((void*) camera_image_captured,(void*) _MAV_PAYLOAD(msg),(int16_t) len);
#endif
}
