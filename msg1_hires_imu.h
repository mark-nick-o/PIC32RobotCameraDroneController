#ifndef __hires_IMU_mavlink1__
#define __hires_IMU_mavlink1__
...
#define MAVLINK_MSG_ID_HIGHRES_IMU_LEN 62u
#define MAVLINK_MSG_ID_HIGHRES_IMU_MIN_LEN 62u
#define MAVLINK_MSG_ID_105_LEN 62u
#define MAVLINK_MSG_ID_105_MIN_LEN 62u

#define MAVLINK_MSG_ID_HIGHRES_IMU_CRC 93u
#define MAVLINK_MSG_ID_105_CRC 93u
...
static inline uint16_t mavlink_msg_highres_imu_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t time_usec, float32_t xacc, float32_t yacc, float32_t zacc, float32_t xgyro, float32_t ygyro, float32_t zgyro, float32_t xmag, float32_t ymag, float32_t zmag, float32_t abs_pressure, float32_t diff_pressure, float32_t pressure_alt, float32_t temperature, uint16_t fields_updated)
{
