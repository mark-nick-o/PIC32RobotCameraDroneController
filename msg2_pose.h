...
// This can be used for pose data from T265 e.g.
// translation {x,y,z} and rotation quartenion {x,y,z,w} and velocity vector {x.y.z}
#define MAVLINK_MSG_ID_HIL_STATE_QUATERNION 115u

#if defined(D_FT900)
typedef struct __mavlink_hil_state_quaternion_t MAVPACKED {
 uint64_t time_usec;                                                            /*< [us] Timestamp (UNIX Epoch time or time since system boot). The receiving end can infer timestamp format (since 1.1.1970 or since system boot) by checking for the magnitude the number.*/
 float32_t attitude_quaternion[4u];                                             /*<  Vehicle attitude expressed as normalized quaternion in w, x, y, z order (with 1 0 0 0 being the null-rotation)*/
 float32_t rollspeed;                                                           /*< [rad/s] Body frame roll / phi angular speed*/
 float32_t pitchspeed;                                                          /*< [rad/s] Body frame pitch / theta angular speed*/
 float32_t yawspeed;                                                            /*< [rad/s] Body frame yaw / psi angular speed*/
...
#define MAVLINK_MSG_ID_HIL_STATE_QUATERNION_LEN 64u
#define MAVLINK_MSG_ID_HIL_STATE_QUATERNION_MIN_LEN 64u
#define MAVLINK_MSG_ID_115_LEN 64u
#define MAVLINK_MSG_ID_115_MIN_LEN 64u

#define MAVLINK_MSG_ID_HIL_STATE_QUATERNION_CRC 4u
#define MAVLINK_MSG_ID_115_CRC 4u

#define MAVLINK_MSG_HIL_STATE_QUATERNION_FIELD_ATTITUDE_QUATERNION_LEN 4u
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_hil_state_quaternion_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, uint64_t time_usec,const float32_t *attitude_quaternion,float32_t rollspeed,float32_t pitchspeed,float32_t yawspeed,int32_t lat,int32_t lon,int32_t alt,int16_t vx,int16_t vy,int16_t vz,uint16_t ind_airspeed,uint16_t true_airspeed,int16_t xacc,int16_t yacc,int16_t zacc)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_HIL_STATE_QUATERNION_LEN];
    _mav_put_uint64_t(buf, 0, time_usec);
...
static inline void mavlink_msg_hil_state_quaternion_send(mavlink_channel_t chan, uint64_t time_usec, const float32_t *attitude_quaternion, float32_t rollspeed, float32_t pitchspeed, float32_t yawspeed, int32_t lat, int32_t lon, int32_t alt, int16_t vx, int16_t vy, int16_t vz, uint16_t ind_airspeed, uint16_t true_airspeed, int16_t xacc, int16_t yacc, int16_t zacc)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_HIL_STATE_QUATERNION_LEN];
    _mav_put_uint64_t(buf, 0, time_usec);
 ...
 */
static inline void mavlink_msg_hil_state_quaternion_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t time_usec, const float32_t *attitude_quaternion, float32_t rollspeed, float32_t pitchspeed, float32_t yawspeed, int32_t lat, int32_t lon, int32_t alt, int16_t vx, int16_t vy, int16_t vz, uint16_t ind_airspeed, uint16_t true_airspeed, int16_t xacc, int16_t yacc, int16_t zacc)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    ...
    packet->yacc = yacc;
    packet->zacc = zacc;
    mav_array_memcpy(packet->attitude_quaternion, attitude_quaternion, sizeof(float32_t)*4);
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_HIL_STATE_QUATERNION, (const char *)packet, MAVLINK_MSG_ID_HIL_STATE_QUATERNION_MIN_LEN, MAVLINK_MSG_ID_HIL_STATE_QUATERNION_LEN, MAVLINK_MSG_ID_HIL_STATE_QUATERNION_CRC);
#endif
}
#endif
 ...
 */
static inline uint16_t mavlink_msg_hil_state_quaternion_get_attitude_quaternion(const mavlink_message_t* msg, float32_t *attitude_quaternion)
{
    return _MAV_RETURN_float32_t_array(msg, attitude_quaternion, 4,  8);
}
 ...
 */
static inline float32_t mavlink_msg_hil_state_quaternion_get_rollspeed(const mavlink_message_t* msg)
{
 ...
 */
static inline float32_t mavlink_msg_hil_state_quaternion_get_pitchspeed(const mavlink_message_t* msg)
{
 ...
 */
static inline float32_t mavlink_msg_hil_state_quaternion_get_yawspeed(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_hil_state_quaternion_decode(const mavlink_message_t* msg, mavlink_hil_state_quaternion_t* hil_state_quaternion)
{
    ...
    memcpy((void*)hil_state_quaternion,(void*) _MAV_PAYLOAD(msg), len);
#endif
}
