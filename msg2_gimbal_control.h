#ifndef __mavlink2_gimbal_command__
#define __mavlink2_gimbal_command__
/* #pragma once
 MESSAGE GIMBAL_CONTROL PACKING */
#define MAVLINK_MSG_ID_GIMBAL_CONTROL 201U

#if defined(D_FT900)
typedef struct MAVPACKED {
 float32_t demanded_rate_x;                                                     /*< [rad/s] Demanded angular rate X.*/
 float32_t demanded_rate_y;                                                     /*< [rad/s] Demanded angular rate Y.*/
 float32_t demanded_rate_z;                                                     /*< [rad/s] Demanded angular rate Z.*/
...
#define MAVLINK_MSG_ID_GIMBAL_CONTROL_LEN 14u
#define MAVLINK_MSG_ID_GIMBAL_CONTROL_MIN_LEN 14u
#define MAVLINK_MSG_ID_201_LEN 14u
#define MAVLINK_MSG_ID_201_MIN_LEN 14u

#define MAVLINK_MSG_ID_GIMBAL_CONTROL_CRC 205u
#define MAVLINK_MSG_ID_201_CRC 205u
...
static inline uint16_t mavlink_msg_gimbal_control_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target_system, uint8_t target_component, float32_t demanded_rate_x, float32_t demanded_rate_y, float32_t demanded_rate_z)
{
...
static inline void mavlink_msg_gimbal_control_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, float32_t demanded_rate_x, float32_t demanded_rate_y, float32_t demanded_rate_z)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_GIMBAL_CONTROL_LEN];
    _mav_put_float(buf, 0, demanded_rate_x);
 ...
 */
static inline void mavlink_msg_gimbal_control_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, float32_t demanded_rate_x, float32_t demanded_rate_y, float32_t demanded_rate_z)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
{
    return _MAV_RETURN_float32_t(msg,  0u);
}
...
static inline void mavlink_msg_gimbal_control_decode(const mavlink_message_t* msg, mavlink_gimbal_control_t* gimbal_control)
{
    ...
    memset(gimbal_control, 0u, MAVLINK_MSG_ID_GIMBAL_CONTROL_LEN);
    memcpy((void*) gimbal_control,(void*) _MAV_PAYLOAD(msg),(int16_t) len);
#endif
}
