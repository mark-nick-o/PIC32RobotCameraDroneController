#ifndef __mav2_vision_posn_delta__
#define __mav2_vision_posn_delta__
...
#if defined(D_FT900)
typedef struct __mavlink_vision_position_delta_t MAVPACKED {
 ...
 float32_t angle_delta[3u];                                                     /*<  Defines a rotation vector in body frame that rotates the vehicle from the previous to the current orientation.*/
 float32_t position_delta[3u];                                                  /*< [m] Change in position from previous to current frame rotated into body frame (0=forward, 1=right, 2=down).*/
 float32_t confidence;                                                          /*< [%] Normalised confidence value from 0 to 100.*/
...
#define MAVLINK_MSG_ID_VISION_POSITION_DELTA_LEN 44u
#define MAVLINK_MSG_ID_VISION_POSITION_DELTA_MIN_LEN 44u
#define MAVLINK_MSG_ID_11011_LEN 44u
#define MAVLINK_MSG_ID_11011_MIN_LEN 44u

#define MAVLINK_MSG_ID_VISION_POSITION_DELTA_CRC 106u
#define MAVLINK_MSG_ID_11011_CRC 106u

#define MAVLINK_MSG_VISION_POSITION_DELTA_FIELD_ANGLE_DELTA_LEN 3u
#define MAVLINK_MSG_VISION_POSITION_DELTA_FIELD_POSITION_DELTA_LEN 3u
...
static inline uint16_t mavlink_msg_vision_position_delta_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t time_usec, uint64_t time_delta_usec, const float32_t *angle_delta, const float32_t *position_delta, float32_t confidence)
{
...
static inline void mavlink_msg_vision_position_delta_send(mavlink_channel_t chan, uint64_t time_usec, uint64_t time_delta_usec, const float32_t *angle_delta, const float32_t *position_delta, float32_t confidence)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_VISION_POSITION_DELTA_LEN];
    _mav_put_uint64_t(buf, 0, time_usec);
 ...
 */
static inline void mavlink_msg_vision_position_delta_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t time_usec, uint64_t time_delta_usec, const float32_t *angle_delta, const float32_t *position_delta, float32_t confidence)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline uint16_t mavlink_msg_vision_position_delta_get_angle_delta(const mavlink_message_t* msg, float32_t *angle_delta)
{
    return _MAV_RETURN_float32_t_array(msg, angle_delta, 3,  16);
}
...
{
    return _MAV_RETURN_float32_t_array(msg, position_delta, 3,  28);
}
 ...
 */
static inline float32_t mavlink_msg_vision_position_delta_get_confidence(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_vision_position_delta_decode(const mavlink_message_t* msg, mavlink_vision_position_delta_t* vision_position_delta)
{
    ...
    memcpy((void*)vision_position_delta,(void*) _MAV_PAYLOAD(msg), len);
#endif
}
