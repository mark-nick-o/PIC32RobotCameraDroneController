#ifndef __mav1_optical_flow
#define __mav1_optical_flow
...
#define MAVLINK_MSG_ID_OPTICAL_FLOW 100u

#if defined(D_FT900)
typedef struct MAVPACKED {
 uint64_t time_usec;                                                            /*< [us] Timestamp (UNIX Epoch time or time since system boot). The receiving end can infer timestamp format (since 1.1.1970 or since system boot) by checking for the magnitude the number.*/
 float32_t flow_comp_m_x;                                                       /*< [m/s] Flow in x-sensor direction, angular-speed compensated*/
 float32_t flow_comp_m_y;                                                       /*< [m/s] Flow in y-sensor direction, angular-speed compensated*/
 float32_t ground_distance;                                                     /*< [m] Ground distance. Positive value: distance known. Negative value: Unknown distance*/
...
#define MAVLINK_MSG_ID_OPTICAL_FLOW_LEN 26u
#define MAVLINK_MSG_ID_OPTICAL_FLOW_MIN_LEN 26u
#define MAVLINK_MSG_ID_100_LEN 26u
#define MAVLINK_MSG_ID_100_MIN_LEN 26u

#define MAVLINK_MSG_ID_OPTICAL_FLOW_CRC 175u
#define MAVLINK_MSG_ID_100_CRC 175u
...
static inline uint16_t mavlink_msg_optical_flow_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t time_usec, uint8_t sensor_id, int16_t flow_x, int16_t flow_y, float32_t flow_comp_m_x, float32_t flow_comp_m_y, uint8_t quality, float ground_distance)
{
...
static inline void mavlink_msg_optical_flow_send(mavlink_channel_t chan, uint64_t time_usec, uint8_t sensor_id, int16_t flow_x, int16_t flow_y, float32_t flow_comp_m_x, float32_t flow_comp_m_y, uint8_t quality, float32_t ground_distance)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_OPTICAL_FLOW_LEN];
    _mav_put_uint64_t(buf, 0, time_usec);
 ...
 */
static inline void mavlink_msg_optical_flow_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t time_usec, uint8_t sensor_id, int16_t flow_x, int16_t flow_y, float32_t flow_comp_m_x, float32_t flow_comp_m_y, uint8_t quality, float32_t ground_distance)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
static inline void mavlink_msg_optical_flow_decode(const mavlink_message_t* msg, mavlink_optical_flow_t* optical_flow)
{
    ...
    memcpy((void*)optical_flow,(void*) _MAV_PAYLOAD(msg),(int16_t) len);
#endif
}
