#ifndef __Vid_strm_stat_m2_
#define __Vid_strm_stat_m2_
//#pragma once
...
#define MAVLINK_MSG_ID_VIDEO_STREAM_STATUS 270u

#if defined(D_FT900)
typedef struct __mavlink_video_stream_status_t MAVPACKED {
...
#define MAVLINK_MSG_ID_VIDEO_STREAM_STATUS_LEN 19u
#define MAVLINK_MSG_ID_VIDEO_STREAM_STATUS_MIN_LEN 19u
#define MAVLINK_MSG_ID_270_LEN 19u
#define MAVLINK_MSG_ID_270_MIN_LEN 19u

#define MAVLINK_MSG_ID_VIDEO_STREAM_STATUS_CRC 59u
#define MAVLINK_MSG_ID_270_CRC 59u
 ...
 */
static inline float32_t mavlink_msg_video_stream_status_get_framerate(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_video_stream_status_decode(const mavlink_message_t* msg, mavlink_video_stream_status_t* video_stream_status)
{
    ...
    memcpy((void*)video_stream_status,(void*) _MAV_PAYLOAD(msg), len);
#endif
}
