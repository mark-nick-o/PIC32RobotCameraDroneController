...
#ifndef __mavlink_camera_information__
#define __mavlink_camera_information__

#define MAVLINK_MSG_ID_CAMERA_INFORMATION 259U

#if defined(D_FT900)
typedef struct __mavlink_camera_information_t MAVPACKED {
 ...
 float32_t focal_length;                                                        /*< [mm] Focal length*/
 float32_t sensor_size_h;                                                       /*< [mm] Image sensor size horizontal*/
 float32_t sensor_size_v;                                                       /*< [mm] Image sensor size vertical*/
 ...
 uint8_t vendor_name[32u];                                                      /*<  Name of the camera vendor*/
 uint8_t model_name[32u];                                                       /*<  Name of the camera model*/
 uint8_t lens_id;                                                               /*<  Reserved for a lens ID*/
 char cam_definition_uri[140u];                                                 /*<  Camera definition URI (if any, otherwise only basic functions will be available). HTTP- (http://) and MAVLink FTP- (mavlinkftp://) formatted URIs are allowed (and both must be supported by any GCS that implements the Camera Protocol).*/
...
#define MAVLINK_MSG_ID_CAMERA_INFORMATION_LEN 235U
#define MAVLINK_MSG_ID_CAMERA_INFORMATION_MIN_LEN 235U
#define MAVLINK_MSG_ID_259_LEN 235U
#define MAVLINK_MSG_ID_259_MIN_LEN 235U

#define MAVLINK_MSG_ID_CAMERA_INFORMATION_CRC 92U
#define MAVLINK_MSG_ID_259_CRC 92U

#define MAVLINK_MSG_CAMERA_INFORMATION_FIELD_VENDOR_NAME_LEN 32U
#define MAVLINK_MSG_CAMERA_INFORMATION_FIELD_MODEL_NAME_LEN 32U
#define MAVLINK_MSG_CAMERA_INFORMATION_FIELD_CAM_DEFINITION_URI_LEN 140U
...
static inline uint16_t mavlink_msg_camera_information_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint32_t time_boot_ms, const uint8_t *vendor_name, const uint8_t *model_name, uint32_t firmware_version, float32_t focal_length, float32_t sensor_size_h, float32_t sensor_size_v, uint16_t resolution_h, uint16_t resolution_v, uint8_t lens_id, uint32_t flags, uint16_t cam_definition_version, const char *cam_definition_uri)
{
...
static inline void mavlink_msg_camera_information_send(mavlink_channel_t chan, uint32_t time_boot_ms, const uint8_t *vendor_name, const uint8_t *model_name, uint32_t firmware_version, float32_t focal_length, float32_t sensor_size_h, float32_t sensor_size_v, uint16_t resolution_h, uint16_t resolution_v, uint8_t lens_id, uint32_t flags, uint16_t cam_definition_version, const char *cam_definition_uri)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_CAMERA_INFORMATION_LEN];
    _mav_put_uint32_t(buf, 0, time_boot_ms);
 ...
 */
static inline void mavlink_msg_camera_information_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_boot_ms, const uint8_t *vendor_name, const uint8_t *model_name, uint32_t firmware_version, float32_t focal_length, float32_t sensor_size_h, float32_t sensor_size_v, uint16_t resolution_h, uint16_t resolution_v, uint8_t lens_id, uint32_t flags, uint16_t cam_definition_version, const char *cam_definition_uri)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    ...
    packet->cam_definition_version = cam_definition_version;
    packet->lens_id = lens_id;
    mav_array_memcpy(packet->vendor_name, vendor_name, sizeof(uint8_t)*32u);
    mav_array_memcpy(packet->model_name, model_name, sizeof(uint8_t)*32u);
    mav_array_memcpy(packet->cam_definition_uri, cam_definition_uri, sizeof(char)*140);
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_CAMERA_INFORMATION, (const char *)packet, MAVLINK_MSG_ID_CAMERA_INFORMATION_MIN_LEN, MAVLINK_MSG_ID_CAMERA_INFORMATION_LEN, MAVLINK_MSG_ID_CAMERA_INFORMATION_CRC);
#endif
}
...
{
    return _MAV_RETURN_uint32_t(msg,  0u);
}
...
{
    return _MAV_RETURN_uint8_t_array(msg, vendor_name, 32u,  30u);
}
...
{
    return _MAV_RETURN_uint8_t_array(msg, model_name, 32u,  62u);
}
...
{
    return _MAV_RETURN_uint32_t(msg,  4u);
}
...
{
    return _MAV_RETURN_float32_t(msg,  8u);
}
...
{
    return _MAV_RETURN_float32_t(msg,  12u);
}
...
{
    return _MAV_RETURN_float32_t(msg,  16u);
}
...
{
    return _MAV_RETURN_uint16_t(msg,  24u);
}
...
{
    return _MAV_RETURN_uint16_t(msg,  26u);
}
...
{
    return _MAV_RETURN_uint8_t(msg,  94u);
}
...
{
    return _MAV_RETURN_uint32_t(msg,  20u);
}
...
{
    return _MAV_RETURN_uint16_t(msg,  28u);
}
...
{
    return _MAV_RETURN_char_array(msg, cam_definition_uri, 140u,  95u);
}
...
static inline void mavlink_msg_camera_information_decode(const mavlink_message_t* msg, mavlink_camera_information_t* camera_information)
{
    ...
    memset(camera_information, 0u, MAVLINK_MSG_ID_CAMERA_INFORMATION_LEN);
    memcpy((void*) camera_information,(void*) _MAV_PAYLOAD(msg),(int16_t) len);
#endif
}
