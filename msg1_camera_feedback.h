#ifndef __cam_fb_mavlink1__
#define __cam_fb_mavlink1__
...
#define MAVLINK_MSG_ID_CAMERA_FEEDBACK_LEN 45u
#define MAVLINK_MSG_ID_CAMERA_FEEDBACK_MIN_LEN 45u
#define MAVLINK_MSG_ID_180_LEN 45u
...
static inline uint16_t mavlink_msg_camera_feedback_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t time_usec, uint8_t target_system, uint8_t cam_idx, uint16_t img_idx, int32_t lat, int32_t lng, float32_t alt_msl, float32_t alt_rel, float32_t roll, float32_t pitch, float32_t yaw, float32_t foc_len, uint8_t flags)
{
...
static inline void mavlink_msg_camera_feedback_send(mavlink_channel_t chan, uint64_t time_usec, uint8_t target_system, uint8_t cam_idx, uint16_t img_idx, int32_t lat, int32_t lng, float32_t alt_msl, float32_t alt_rel, float32_t roll, float32_t pitch, float32_t yaw, float32_t foc_len, uint8_t flags)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_CAMERA_FEEDBACK_LEN];
    _mav_put_uint64_t(buf, 0, time_usec);
 ...
 */
static inline void mavlink_msg_camera_feedback_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t time_usec, uint8_t target_system, uint8_t cam_idx, uint16_t img_idx, int32_t lat, int32_t lng, float32_t alt_msl, float32_t alt_rel, float32_t roll, float32_t pitch, float32_t yaw, float32_t foc_len, uint8_t flags)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
