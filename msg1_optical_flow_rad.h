#ifndef __mav1_optical_flow_rad
#define __mav1_optical_flow_rad
...
#define MAVLINK_MSG_ID_OPTICAL_FLOW_RAD 106u
...
typedef struct MAVPACKED {
 ...
 float32_t integrated_x;                                                        /*< [rad] Flow around X axis (Sensor RH rotation about the X axis induces a positive flow. Sensor linear motion along the positive Y axis induces a negative flow.)*/
 float32_t integrated_y;                                                        /*< [rad] Flow around Y axis (Sensor RH rotation about the Y axis induces a positive flow. Sensor linear motion along the positive X axis induces a positive flow.)*/
 float32_t integrated_xgyro;                                                    /*< [rad] RH rotation around X axis*/
 float32_t integrated_ygyro;                                                    /*< [rad] RH rotation around Y axis*/
 float32_t integrated_zgyro;                                                    /*< [rad] RH rotation around Z axis*/
 uint32_t time_delta_distance_us;                                               /*< [us] Time since the distance was sampled.*/
 float32_t distance;                                                            /*< [m] Distance to the center of the flow field. Positive value (including zero): distance known. Negative value: Unknown distance.*/
...
} mavlink_optical_flow_rad_t;                                                   // tail byte type
#else
MAVPACKED(
...
#define MAVLINK_MSG_ID_OPTICAL_FLOW_RAD_LEN 44u
#define MAVLINK_MSG_ID_OPTICAL_FLOW_RAD_MIN_LEN 44u
#define MAVLINK_MSG_ID_106_LEN 44u
#define MAVLINK_MSG_ID_106_MIN_LEN 44u

#define MAVLINK_MSG_ID_OPTICAL_FLOW_RAD_CRC 138u
#define MAVLINK_MSG_ID_106_CRC 138u
...
static inline uint16_t mavlink_msg_optical_flow_rad_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t time_usec, uint8_t sensor_id, uint32_t integration_time_us, float32_t integrated_x, float32_t integrated_y, float32_t integrated_xgyro, float integrated_ygyro, float integrated_zgyro, int16_t temperature, uint8_t quality, uint32_t time_delta_distance_us, float distance)
{
...
static inline void mavlink_msg_optical_flow_rad_decode(const mavlink_message_t* msg, mavlink_optical_flow_rad_t* optical_flow_rad)
{
    ...
    memcpy((void*)optical_flow_rad,(void*) _MAV_PAYLOAD(msg),(int16_t) len);
#endif
}
