#ifndef __mav2_global_pos_int
#define __mav2_global_pos_int
...
#define MAVLINK_MSG_ID_GLOBAL_POSITION_INT_LEN 28u
#define MAVLINK_MSG_ID_GLOBAL_POSITION_INT_MIN_LEN 28u
#define MAVLINK_MSG_ID_33_LEN 28u
#define MAVLINK_MSG_ID_33_MIN_LEN 28u

#define MAVLINK_MSG_ID_GLOBAL_POSITION_INT_CRC 104u
#define MAVLINK_MSG_ID_33_CRC 104u
...
#else
    len = msg->len < MAVLINK_MSG_ID_GLOBAL_POSITION_INT_LEN? msg->len : MAVLINK_MSG_ID_GLOBAL_POSITION_INT_LEN;
    memset(global_position_int, 0, MAVLINK_MSG_ID_GLOBAL_POSITION_INT_LEN);
    memcpy((void*)global_position_int,(void*) _MAV_PAYLOAD(msg),(int16_t) len);
#endif
}
