#ifndef __gimbal_device_info_mavlink2__
#define __gimbal_device_info_mavlink2__
...
#define MAVLINK_MSG_ID_GIMBAL_DEVICE_INFORMATION 283u

#if defined(D_FT900)
typedef struct MAVPACKED {
 ...
 float32_t tilt_max;                                                            /*< [rad] Maximum tilt/pitch angle (positive: up, negative: down)*/
 float32_t tilt_min;                                                            /*< [rad] Minimum tilt/pitch angle (positive: up, negative: down)*/
 float32_t tilt_rate_max;                                                       /*< [rad/s] Maximum tilt/pitch angular rate (positive: up, negative: down)*/
 float32_t pan_max;                                                             /*< [rad] Maximum pan/yaw angle (positive: to the right, negative: to the left)*/
 float32_t pan_min;                                                             /*< [rad] Minimum pan/yaw angle (positive: to the right, negative: to the left)*/
 float32_t pan_rate_max;                                                        /*< [rad/s] Minimum pan/yaw angular rate (positive: to the right, negative: to the left)*/
 uint16_t cap_flags;                                                            /*<  Bitmap of gimbal capability flags.*/
 uint8_t vendor_name[32u];                                                      /*<  Name of the gimbal vendor*/
 uint8_t model_name[32u];                                                       /*<  Name of the gimbal model*/
...
#define MAVLINK_MSG_ID_GIMBAL_DEVICE_INFORMATION_LEN 98u
#define MAVLINK_MSG_ID_GIMBAL_DEVICE_INFORMATION_MIN_LEN 98u
#define MAVLINK_MSG_ID_283_LEN 98u
#define MAVLINK_MSG_ID_283_MIN_LEN 98u

#define MAVLINK_MSG_ID_GIMBAL_DEVICE_INFORMATION_CRC 247u
#define MAVLINK_MSG_ID_283_CRC 247u

#define MAVLINK_MSG_GIMBAL_DEVICE_INFORMATION_FIELD_VENDOR_NAME_LEN 32u
#define MAVLINK_MSG_GIMBAL_DEVICE_INFORMATION_FIELD_MODEL_NAME_LEN 32u
 ...
 */
static inline uint16_t mavlink_msg_gimbal_device_information_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, uint32_t time_boot_ms, const uint8_t *vendor_name, const uint8_t *model_name, uint32_t firmware_version, uint16_t cap_flags, float32_t tilt_max, float32_t tilt_min, float32_t tilt_rate_max, float32_t pan_max, float32_t pan_min, float32_t pan_rate_max)
{
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_gimbal_device_information_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, uint32_t time_boot_ms,const uint8_t *vendor_name,const uint8_t *model_name,uint32_t firmware_version,uint16_t cap_flags,float tilt_max,float32_t tilt_min,float32_t tilt_rate_max,float32_t pan_max,float32_t pan_min,float32_t pan_rate_max)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_GIMBAL_DEVICE_INFORMATION_LEN];
    _mav_put_uint32_t(buf, 0, time_boot_ms);
...
static inline void mavlink_msg_gimbal_device_information_send(mavlink_channel_t chan, uint32_t time_boot_ms, const uint8_t *vendor_name, const uint8_t *model_name, uint32_t firmware_version, uint16_t cap_flags, float32_t tilt_max, float32_t tilt_min, float32_t tilt_rate_max, float32_t pan_max, float32_t pan_min, float32_t pan_rate_max)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_GIMBAL_DEVICE_INFORMATION_LEN];
    _mav_put_uint32_t(buf, 0, time_boot_ms);
 ...
 */
static inline void mavlink_msg_gimbal_device_information_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_boot_ms, const uint8_t *vendor_name, const uint8_t *model_name, uint32_t firmware_version, uint16_t cap_flags, float32_t tilt_max, float32_t tilt_min, float32_t tilt_rate_max, float pan_max, float pan_min, float pan_rate_max)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline float32_t mavlink_msg_gimbal_device_information_get_tilt_max(const mavlink_message_t* msg)
{
 ...
 */
static inline float32_t mavlink_msg_gimbal_device_information_get_tilt_min(const mavlink_message_t* msg)
{
 ...
 */
static inline float32_t mavlink_msg_gimbal_device_information_get_tilt_rate_max(const mavlink_message_t* msg)
{
 ...
 */
static inline float32_t mavlink_msg_gimbal_device_information_get_pan_max(const mavlink_message_t* msg)
{
...
#else
    len = msg->len < MAVLINK_MSG_ID_GIMBAL_DEVICE_INFORMATION_LEN? msg->len : MAVLINK_MSG_ID_GIMBAL_DEVICE_INFORMATION_LEN;
    memset(gimbal_device_information, 0, MAVLINK_MSG_ID_GIMBAL_DEVICE_INFORMATION_LEN);
    memcpy((void*)gimbal_device_information,(void*) _MAV_PAYLOAD(msg),(int16_t) len);
#endif
}
