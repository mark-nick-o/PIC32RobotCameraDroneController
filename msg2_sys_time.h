#ifndef __system_time_mv2__
#define __system_time_mv2__
//#pragma once
...
#define MAVLINK_MSG_ID_SYSTEM_TIME 2u

#if defined(D_FT900)
typedef struct __mavlink_system_time_t MAVPACKED {
...
#define MAVLINK_MSG_ID_SYSTEM_TIME_LEN 12u
#define MAVLINK_MSG_ID_SYSTEM_TIME_MIN_LEN 12u
#define MAVLINK_MSG_ID_2_LEN 12u
#define MAVLINK_MSG_ID_2_MIN_LEN 12u

#define MAVLINK_MSG_ID_SYSTEM_TIME_CRC 137u
#define MAVLINK_MSG_ID_2_CRC 137u
...
static inline void mavlink_msg_system_time_decode(const mavlink_message_t* msg, mavlink_system_time_t* system_time)
{
    ...
    memcpy((void*)system_time,(void*) _MAV_PAYLOAD(msg), len);
#endif
}
