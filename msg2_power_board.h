#ifndef __cmd_power_board_mav2__
#define __cmd_power_board_mav2__
...
#define MAVLINK_MSG_ID_SENS_POWER_BOARD 212u

#if defined(D_FT900)
typedef struct __mavlink_sens_power_board_t MAVPACKED {
 uint64_t timestamp;                                                            /*< [us] Timestamp*/
 float32_t pwr_brd_system_volt;                                                 /*< [V] Power board system voltage*/
 float32_t pwr_brd_servo_volt;                                                  /*< [V] Power board servo voltage*/
 float32_t pwr_brd_digital_volt;                                                /*< [V] Power board digital voltage*/
 float32_t pwr_brd_mot_l_amp;                                                   /*< [A] Power board left motor current sensor*/
 float32_t pwr_brd_mot_r_amp;                                                   /*< [A] Power board right motor current sensor*/
 float32_t pwr_brd_analog_amp;                                                  /*< [A] Power board analog current sensor*/
 float32_t pwr_brd_digital_amp;                                                 /*< [A] Power board digital current sensor*/
 float32_t pwr_brd_ext_amp;                                                     /*< [A] Power board extension current sensor*/
 float32_t pwr_brd_aux_amp;                                                     /*< [A] Power board aux current sensor*/
...
#define MAVLINK_MSG_ID_SENS_POWER_BOARD_LEN 46u
#define MAVLINK_MSG_ID_SENS_POWER_BOARD_MIN_LEN 46u
#define MAVLINK_MSG_ID_212_LEN 46u
#define MAVLINK_MSG_ID_212_MIN_LEN 46u

#define MAVLINK_MSG_ID_SENS_POWER_BOARD_CRC 222u
#define MAVLINK_MSG_ID_212_CRC 222u
...
static inline uint16_t mavlink_msg_sens_power_board_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t timestamp, uint8_t pwr_brd_status, uint8_t pwr_brd_led_status, float32_t pwr_brd_system_volt, float32_t pwr_brd_servo_volt, float32_t pwr_brd_digital_volt, float32_t pwr_brd_mot_l_amp, float32_t pwr_brd_mot_r_amp, float32_t pwr_brd_analog_amp, float32_t pwr_brd_digital_amp, float32_t pwr_brd_ext_amp, float32_t pwr_brd_aux_amp)
{
...
static inline uint16_t mavlink_msg_sens_power_board_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
                               mavlink_message_t* msg,
                                   uint64_t timestamp,uint8_t pwr_brd_status,uint8_t pwr_brd_led_status,float pwr_brd_system_volt,float32_t pwr_brd_servo_volt,float32_t pwr_brd_digital_volt,float32_t pwr_brd_mot_l_amp,float32_t pwr_brd_mot_r_amp,float32_t pwr_brd_analog_amp,float32_t pwr_brd_digital_amp,float32_t pwr_brd_ext_amp,float32_t pwr_brd_aux_amp)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SENS_POWER_BOARD_LEN];
    _mav_put_uint64_t(buf, 0, timestamp);
 ...
 */
static inline float32_t mavlink_msg_sens_power_board_get_pwr_brd_system_volt(const mavlink_message_t* msg)
{
 ...
 */
static inline float32_t mavlink_msg_sens_power_board_get_pwr_brd_servo_volt(const mavlink_message_t* msg)
{
 ...
 */
static inline float32_t mavlink_msg_sens_power_board_get_pwr_brd_digital_volt(const mavlink_message_t* msg)
{
 ...
 */
static inline float32_t mavlink_msg_sens_power_board_get_pwr_brd_mot_l_amp(const mavlink_message_t* msg)
{
 ...
 */
static inline float32_t mavlink_msg_sens_power_board_get_pwr_brd_mot_r_amp(const mavlink_message_t* msg)
{
 ...
 */
static inline float32_t mavlink_msg_sens_power_board_get_pwr_brd_analog_amp(const mavlink_message_t* msg)
{
 ...
 */
static inline float32_t mavlink_msg_sens_power_board_get_pwr_brd_digital_amp(const mavlink_message_t* msg)
{
 ...
 */
static inline float32_t mavlink_msg_sens_power_board_get_pwr_brd_ext_amp(const mavlink_message_t* msg)
{
 ...
 */
static inline float32_t mavlink_msg_sens_power_board_get_pwr_brd_aux_amp(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_sens_power_board_decode(const mavlink_message_t* msg, mavlink_sens_power_board_t* sens_power_board)
{
    ...
    memcpy((void*)sens_power_board,(void*) _MAV_PAYLOAD(msg),(int16_t) len);
#endif
}
...
#endif /* end library for power board data */