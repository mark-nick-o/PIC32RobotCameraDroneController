#ifndef __rtk_mavlnk1__
#define __rtk_mavlnk1__
/* #pragma once */
...
#define MAVLINK_MSG_ID_GPS_RTK 127u

#if defined(D_FT900)
typedef struct __mavlink_gps_rtk_t MAVPACKED {
...
#define MAVLINK_MSG_ID_GPS_RTK_LEN 35u
#define MAVLINK_MSG_ID_GPS_RTK_MIN_LEN 35u
#define MAVLINK_MSG_ID_127_LEN 35u
#define MAVLINK_MSG_ID_127_MIN_LEN 35u

#define MAVLINK_MSG_ID_GPS_RTK_CRC 25u
#define MAVLINK_MSG_ID_127_CRC 25u
...
static inline void mavlink_msg_gps_rtk_decode(const mavlink_message_t* msg, mavlink_gps_rtk_t* gps_rtk)
{
    ...
    memcpy((void*) gps_rtk,(void*) _MAV_PAYLOAD(msg), len);
#endif
}
