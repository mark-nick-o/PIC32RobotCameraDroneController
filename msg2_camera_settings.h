...
#define MAVLINK_MSG_ID_CAMERA_SETTINGS 260U

#if defined(D_FT900)
typedef struct __mavlink_camera_settings_t MAVPACKED {
 uint32_t time_boot_ms;                                                         /*< [ms] Timestamp (time since system boot).*/
 uint8_t mode_id;                                                               /*<  Camera mode*/
 float32_t zoomLevel;                                                           /*<  Current zoom level (0.0 to 100.0, NaN if not known)*/
 float32_t focusLevel;                                                          /*<  Current focus level (0.0 to 100.0, NaN if not known)*/
...
#define MAVLINK_MSG_ID_CAMERA_SETTINGS_LEN 13U
#define MAVLINK_MSG_ID_CAMERA_SETTINGS_MIN_LEN 5U
#define MAVLINK_MSG_ID_260_LEN 13U
#define MAVLINK_MSG_ID_260_MIN_LEN 5U

#define MAVLINK_MSG_ID_CAMERA_SETTINGS_CRC 146U
#define MAVLINK_MSG_ID_260_CRC 146U
...
static inline uint16_t mavlink_msg_camera_settings_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan,
                               mavlink_message_t* msg,
                                   uint32_t time_boot_ms,uint8_t mode_id,float32_t zoomLevel,float32_t focusLevel)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_CAMERA_SETTINGS_LEN];
    _mav_put_uint32_t(buf, 0, time_boot_ms);
...
static inline void mavlink_msg_camera_settings_send(mavlink_channel_t chan, uint32_t time_boot_ms, uint8_t mode_id, float32_t zoomLevel, float32_t focusLevel)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_CAMERA_SETTINGS_LEN];
    _mav_put_uint32_t(buf, 0, time_boot_ms);
 ...
 */
static inline void mavlink_msg_camera_settings_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_boot_ms, uint8_t mode_id, float32_t zoomLevel, float32_t focusLevel)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
{
    return _MAV_RETURN_float32_t(msg,  5u);
}
...
{
    return _MAV_RETURN_float32_t(msg,  9u);
}
...
static inline void mavlink_msg_camera_settings_decode(const mavlink_message_t* msg, mavlink_camera_settings_t* camera_settings)
{
    ...
    memset(camera_settings, 0u, MAVLINK_MSG_ID_CAMERA_SETTINGS_LEN);
    memcpy((void*) camera_settings,(void*) _MAV_PAYLOAD(msg),(int16_t) len);
#endif
}