#ifndef __mav2_optical_flow
#define __mav2_optical_flow
...
typedef struct MAVPACKED {
 ...
 float32_t flow_rate_x;                                                         /*< [rad/s] Flow rate about X axis*/
 float32_t flow_rate_y;                                                         /*< [rad/s] Flow rate about Y axis*/
...
#define MAVLINK_MSG_ID_OPTICAL_FLOW_LEN 34u
#define MAVLINK_MSG_ID_OPTICAL_FLOW_MIN_LEN 26u
#define MAVLINK_MSG_ID_100_LEN 34u
...
{
    return _MAV_RETURN_float32_t(msg,  26);
}
...
{
    return _MAV_RETURN_float32_t(msg,  30);
}
