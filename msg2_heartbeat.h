...
#ifndef __heartbeat_mavlink2__
#define __heartbeat_mavlink2__

#define MAVLINK_MSG_ID_HEARTBEAT 0u

#if defined(D_FT900)
typedef struct __mavlink_heartbeat_t MAVPACKED {
...
#define MAVLINK_MSG_ID_HEARTBEAT_MIN_LEN 9u
#define MAVLINK_MSG_ID_0_LEN 9u
#define MAVLINK_MSG_ID_0_MIN_LEN 9u

#define MAVLINK_MSG_ID_HEARTBEAT_CRC 50u
#define MAVLINK_MSG_ID_0_CRC 50u
...
static inline void mavlink_msg_heartbeat_decode(const mavlink_message_t* msg, mavlink_heartbeat_t* heartbeat)
{
    ...
    memset(heartbeat, 0u, MAVLINK_MSG_ID_HEARTBEAT_LEN);
    memcpy((void*)heartbeat,(void*) _MAV_PAYLOAD(msg),(int16_t) len);
#endif
}
