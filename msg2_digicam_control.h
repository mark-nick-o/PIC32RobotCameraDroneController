...
{
    return _MAV_RETURN_uint8_t(msg,  4u);
}
...
{
    return _MAV_RETURN_uint8_t(msg,  5u);
}
...
{
    return _MAV_RETURN_uint8_t(msg,  6u);
}
...
{
    return _MAV_RETURN_uint8_t(msg,  7u);
}
...
{
    return _MAV_RETURN_int8_t(msg,  8u);
}
...
{
    return _MAV_RETURN_uint8_t(msg,  9u);
}
...
{
    return _MAV_RETURN_uint8_t(msg,  10u);
}
...
{
    return _MAV_RETURN_uint8_t(msg,  11u);
}
...
{
    return _MAV_RETURN_uint8_t(msg,  12u);
}
 ...
 */
static inline float32_t mavlink_msg_digicam_control_get_extra_value(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_digicam_control_decode(const mavlink_message_t* msg, mavlink_digicam_control_t* digicam_control)
{
    ...
    memset(digicam_control, 0u, MAVLINK_MSG_ID_DIGICAM_CONTROL_LEN);
