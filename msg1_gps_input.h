#ifndef __mav1_gps_input__
#define __mav1_gps_input__
...
#define MAVLINK_MSG_ID_GPS_INPUT 232u
#if defined(D_FT900)
typedef struct __mavlink_gps_input_t MAVPACKED {
...
#define MAVLINK_MSG_ID_GPS_INPUT_LEN 63u
#define MAVLINK_MSG_ID_GPS_INPUT_MIN_LEN 63u
#define MAVLINK_MSG_ID_232_LEN 63u
#define MAVLINK_MSG_ID_232_MIN_LEN 63u

#define MAVLINK_MSG_ID_GPS_INPUT_CRC 151u
#define MAVLINK_MSG_ID_232_CRC 151u
...
static inline uint16_t mavlink_msg_gps_input_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t time_usec, uint8_t gps_id, uint16_t ignore_flags, uint32_t time_week_ms, uint16_t time_week, uint8_t fix_type, int32_t lat, int32_t lon, float32_t alt, float32_t hdop, float32_t vdop, float32_t vn, float32_t ve, float32_t vd, float32_t speed_accuracy, float32_t horiz_accuracy, float32_t vert_accuracy, uint8_t satellites_visible)
{
...
static inline void mavlink_msg_gps_input_send(mavlink_channel_t chan, uint64_t time_usec, uint8_t gps_id, uint16_t ignore_flags, uint32_t time_week_ms, uint16_t time_week, uint8_t fix_type, int32_t lat, int32_t lon, float32_t alt, float32_t hdop, float32_t vdop, float32_t vn, float32_t ve, float32_t vd, float32_t speed_accuracy, float32_t horiz_accuracy, float32_t vert_accuracy, uint8_t satellites_visible)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_GPS_INPUT_LEN];
    _mav_put_uint64_t(buf, 0, time_usec);
 ...
 */
static inline void mavlink_msg_gps_input_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t time_usec, uint8_t gps_id, uint16_t ignore_flags, uint32_t time_week_ms, uint16_t time_week, uint8_t fix_type, int32_t lat, int32_t lon, float32_t alt, float32_t hdop, float32_t vdop, float32_t vn, float32_t ve, float32_t vd, float32_t speed_accuracy, float32_t horiz_accuracy, float32_t vert_accuracy, uint8_t satellites_visible)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
static inline void mavlink_msg_gps_input_decode(const mavlink_message_t* msg, mavlink_gps_input_t* gps_input)
{
    ...
    memset(gps_input, 0u, MAVLINK_MSG_ID_GPS_INPUT_LEN);
    memcpy((void*)gps_input,(void*) _MAV_PAYLOAD(msg),(int16_t) len);
#endif
}
