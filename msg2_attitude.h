#ifndef __mav2_attitude__
#define __mav2_attitude__
...
#if defined(D_FT900)
typedef struct __mavlink_attitude_t MAVPACKED {
 uint32_t time_boot_ms;                                                         /*< [ms] Timestamp (time since system boot).*/
 float32_t roll;                                                                /*< [rad] Roll angle (-pi..+pi)*/
 float32_t pitch;                                                               /*< [rad] Pitch angle (-pi..+pi)*/
 float32_t yaw;                                                                 /*< [rad] Yaw angle (-pi..+pi)*/
...
#define MAVLINK_MSG_ID_ATTITUDE_LEN 28u
#define MAVLINK_MSG_ID_ATTITUDE_MIN_LEN 28u
#define MAVLINK_MSG_ID_30_LEN 28u
#define MAVLINK_MSG_ID_30_MIN_LEN 28u

#define MAVLINK_MSG_ID_ATTITUDE_CRC 39u
#define MAVLINK_MSG_ID_30_CRC 39u
...
static inline uint16_t mavlink_msg_attitude_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint32_t time_boot_ms, float32_t roll, float32_t pitch, float32_t yaw, float32_t rollspeed, float32_t pitchspeed, float32_t yawspeed)
{
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_attitude_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, uint32_t time_boot_ms,float32_t roll,float32_t pitch,float32_t yaw,float32_t rollspeed,float32_t pitchspeed,float32_t yawspeed)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_ATTITUDE_LEN];
    _mav_put_uint32_t(buf, 0, time_boot_ms);
...
static inline void mavlink_msg_attitude_send(mavlink_channel_t chan, uint32_t time_boot_ms, float32_t roll, float32_t pitch, float32_t yaw, float32_t rollspeed, float32_t pitchspeed, float32_t yawspeed)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_ATTITUDE_LEN];
    _mav_put_uint32_t(buf, 0, time_boot_ms);
 ...
 */
static inline void mavlink_msg_attitude_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_boot_ms, float32_t roll, float32_t pitch, float32_t yaw, float32_t rollspeed, float32_t pitchspeed, float32_t yawspeed)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
{
    return _MAV_RETURN_float32_t(msg,  4);
}
...
static inline void mavlink_msg_attitude_decode(const mavlink_message_t* msg, mavlink_attitude_t* attitude)
{
    ...
    memcpy((void*)attitude,(void*) _MAV_PAYLOAD(msg), len);
#endif
}
