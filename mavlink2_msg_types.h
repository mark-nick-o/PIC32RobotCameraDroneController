#ifndef __mavlink2_msg_types
#define __mavlink2_msg_types
...
//#include <stdbool.h>
#ifndef bool
#define bool uint8_t                                                            // temparary define for this lib
#endif
#include <stdint.h>
...
/* #ifdef __GNUC__
  ...
  #define MAVPACKED __attribute__((packed))                                     /* keil arm can also use #pragma pack(1) to pack to byte boundaries #pragma pack(4) to align to 4 byte boundaries */
#elif (defined(__CC_ARM) || defined(__IAR_SYSTEMS_ICC__))                       /* Keil MDK-ARM compiler ? or IAR C compiler */
  #define MAVPACKED __packed
...
#define MAVLINK_CORE_HEADER_MAVLINK1_LEN 5u                                     ///< Length of MAVLink1 core header (of the comm. layer)
#define MAVLINK_NUM_HEADER_BYTES (MAVLINK_CORE_HEADER_LEN + 1u)                 ///< Length of all header bytes, including core and stx
...
*/
#if !(MCU_NAME == PIC32MX795F512L)                                              // mikroe c for pic32 doesnt allow this
MAVPACKED(
typedef struct param_union_extended {
    union {
    struct {
        uint8_t is_double:1u;
        uint8_t mavlink_type:7u;
        union {
            char c;
            uint8_t uint8;
            int8_t int8;
...
typedef struct {
  ...
  mavlink_union1 union1;
}) mavlink_struct_inside1;
typedef union 
{
   mavlink_struct_inside1 struct1;
   uint8_t dataV[8u];
} mavlink_param_union_double_t;
#endif

typedef enum {
  MAV_LOOK_FOR_START = 0u,
  MAV2_GET_PAY_LEN = 1u,
  MAV2_GET_FLAG1 = 2u,
  MAV2_GET_FLAG2 = 3u,
  MAV2_GET_SEQUENCE = 4u,
  MAV2_GET_SYSTEM = 5u,
  MAV2_GET_COMPONENT = 6u,
  MAV2_GET_MESSAGE1 = 7u,
  MAV2_GET_MESSAGE2 = 8u,
  MAV2_GET_MESSAGE3 = 9u,
  MAV2_PREAMBLE = 10u,
} mavlink2CollectState_e;                                                       /* mavlink2 packet collection states  */

#define MAV2_SIG_BYTES 13u
...
typedef struct __mavlink_message 
{
    ...
    uint64_t payload64[(MAVLINK_MAX_PAYLOAD_LEN+MAVLINK_NUM_CHECKSUM_BYTES+7u)/8u];
    uint8_t ck[2u];                                                             ///< incoming checksum bytes
...
#define MAVLINK_IFLAG_MASK    0x01u                                             // mask of all understood bits
