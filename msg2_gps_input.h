...
#ifndef __mav2_gps_input__
#define __mav2_gps_input__
...
{
    return _MAV_RETURN_uint8_t(msg,  60u);
}
...
{
    return _MAV_RETURN_uint16_t(msg,  56u);
}
...
{
    return _MAV_RETURN_uint16_t(msg,  58u);
}
...
{
    return _MAV_RETURN_uint8_t(msg,  61u);
}
...
{
    return _MAV_RETURN_float32_t(msg,  20u);
}
...
{
    return _MAV_RETURN_float32_t(msg,  24u);
}
...
{
    return _MAV_RETURN_float32_t(msg,  28u);
}
...
{
    return _MAV_RETURN_float32_t(msg,  32u);
}
...
{
    return _MAV_RETURN_float32_t(msg,  36u);
}
...
{
    return _MAV_RETURN_float32_t(msg,  40u);
}
...
{
    return _MAV_RETURN_float32_t(msg,  44u);
}
...
{
    return _MAV_RETURN_float32_t(msg,  48u);
}
...
{
    return _MAV_RETURN_float32_t(msg,  52u);
}
...
{
    return _MAV_RETURN_uint8_t(msg,  62u);
}
