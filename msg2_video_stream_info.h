#ifndef ___vid_strm_info_mav2__
#define ___vid_strm_info_mav2__
...
#define MAVLINK_MSG_ID_VIDEO_STREAM_INFORMATION 269u

#if defined(D_FT900)
typedef struct __mavlink_video_stream_information_t MAVPACKED {
 float32_t framerate;                                                           /*< [Hz] Frame rate.*/
 ...
 char name[32u];                                                                /*<  Stream name.*/
 char uri[160u];                                                                /*<  Video stream URI (TCP or RTSP URI ground station should connect to) or port number (UDP port ground station should listen to).*/
...
#define MAVLINK_MSG_ID_VIDEO_STREAM_INFORMATION_LEN 213u
#define MAVLINK_MSG_ID_VIDEO_STREAM_INFORMATION_MIN_LEN 213u
#define MAVLINK_MSG_ID_269_LEN 213u
#define MAVLINK_MSG_ID_269_MIN_LEN 213u

#define MAVLINK_MSG_ID_VIDEO_STREAM_INFORMATION_CRC 109u
#define MAVLINK_MSG_ID_269_CRC 109u

#define MAVLINK_MSG_VIDEO_STREAM_INFORMATION_FIELD_NAME_LEN 32u
#define MAVLINK_MSG_VIDEO_STREAM_INFORMATION_FIELD_URI_LEN 160u
 ...
 */
static inline float32_t mavlink_msg_video_stream_information_get_framerate(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_video_stream_information_decode(const mavlink_message_t* msg, mavlink_video_stream_information_t* video_stream_information)
{
    ...
    memcpy((void*)video_stream_information,(void*) _MAV_PAYLOAD(msg), len);
#endif
}
