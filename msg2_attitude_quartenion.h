#ifndef __mavlink2_attit_quart__
#define __mavlink2_attit_quart__
...
#define MAVLINK_MSG_ID_ATTITUDE_QUATERNION 31u

#if defined(D_FT900)
typedef struct __mavlink_attitude_quaternion_t MAVPACKED {
...
#define MAVLINK_MSG_ID_ATTITUDE_QUATERNION_LEN 32u
#define MAVLINK_MSG_ID_ATTITUDE_QUATERNION_MIN_LEN 32u
#define MAVLINK_MSG_ID_31_LEN 32u
#define MAVLINK_MSG_ID_31_MIN_LEN 32u

#define MAVLINK_MSG_ID_ATTITUDE_QUATERNION_CRC 246u
#define MAVLINK_MSG_ID_31_CRC 246u
...
static inline uint16_t mavlink_msg_attitude_quaternion_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint32_t time_boot_ms, float32_t q1, float32_t q2, float32_t q3, float32_t q4, float32_t rollspeed, float32_t pitchspeed, float32_t yawspeed)
{
...
static inline void mavlink_msg_attitude_quaternion_send(mavlink_channel_t chan, uint32_t time_boot_ms, float32_t q1, float32_t q2, float32_t q3, float32_t q4, float32_t rollspeed, float32_t pitchspeed, float32_t yawspeed)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_ATTITUDE_QUATERNION_LEN];
    _mav_put_uint32_t(buf, 0, time_boot_ms);
 ...
 */
static inline void mavlink_msg_attitude_quaternion_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_boot_ms, float32_t q1, float32_t q2, float32_t q3, float32_t q4, float32_t rollspeed, float32_t pitchspeed, float32_t yawspeed)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
static inline void mavlink_msg_attitude_quaternion_decode(const mavlink_message_t* msg, mavlink_attitude_quaternion_t* attitude_quaternion)
{
    ...
    memcpy((void*)attitude_quaternion,(void*) _MAV_PAYLOAD(msg),(int16_t) len);
#endif
}
...
#endif /* end library for quartenion */