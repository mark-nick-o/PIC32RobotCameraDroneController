#ifndef __mav1_req_data_stream__
#define __mav1_req_data_stream__
...
#if defined(D_FT900)
typedef struct __mavlink_request_data_stream_t MAVPACKED {
...
#define MAVLINK_MSG_ID_REQUEST_DATA_STREAM_MIN_LEN 6u
#define MAVLINK_MSG_ID_66_LEN 6u
#define MAVLINK_MSG_ID_66_MIN_LEN 6u

#define MAVLINK_MSG_ID_REQUEST_DATA_STREAM_CRC 148u
#define MAVLINK_MSG_ID_66_CRC 148u
...
static inline void mavlink_msg_request_data_stream_decode(const mavlink_message_t* msg, mavlink_request_data_stream_t* request_data_stream)
{
    ...
    memcpy((void*)request_data_stream,(void*)_MAV_PAYLOAD(msg), len);
#endif
}
