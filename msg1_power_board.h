#ifndef __cmd_power_board_mav1__
#define __cmd_power_board_mav1__
...
static inline void mavlink_msg_sens_power_board_send(mavlink_channel_t chan, uint64_t timestamp, uint8_t pwr_brd_status, uint8_t pwr_brd_led_status, float32_t pwr_brd_system_volt, float32_t pwr_brd_servo_volt, float32_t pwr_brd_digital_volt, float32_t pwr_brd_mot_l_amp, float32_t pwr_brd_mot_r_amp, float32_t pwr_brd_analog_amp, float32_t pwr_brd_digital_amp, float32_t pwr_brd_ext_amp, float32_t pwr_brd_aux_amp)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SENS_POWER_BOARD_LEN];
    _mav_put_uint64_t(buf, 0, timestamp);
 ...
 */
static inline void mavlink_msg_sens_power_board_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t timestamp, uint8_t pwr_brd_status, uint8_t pwr_brd_led_status, float32_t pwr_brd_system_volt, float32_t pwr_brd_servo_volt, float32_t pwr_brd_digital_volt, float32_t pwr_brd_mot_l_amp, float32_t pwr_brd_mot_r_amp, float32_t pwr_brd_analog_amp, float32_t pwr_brd_digital_amp, float32_t pwr_brd_ext_amp, float32_t pwr_brd_aux_amp)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
