#ifndef __mav1_airspeeds__
#define __mav1_airspeeds__
...
#define MAVLINK_MSG_ID_AIRSPEEDS 182u

#if defined(D_FT900)
typedef struct __mavlink_airspeeds_t MAVPACKED {
...
#define MAVLINK_MSG_ID_AIRSPEEDS_LEN 16u
#define MAVLINK_MSG_ID_AIRSPEEDS_MIN_LEN 16u
#define MAVLINK_MSG_ID_182_LEN 16u
#define MAVLINK_MSG_ID_182_MIN_LEN 16u

#define MAVLINK_MSG_ID_AIRSPEEDS_CRC 154u
#define MAVLINK_MSG_ID_182_CRC 154u
...
static inline void mavlink_msg_airspeeds_decode(const mavlink_message_t* msg, mavlink_airspeeds_t* airspeeds)
{
    ...
    memcpy((void*) airspeeds,(void*) _MAV_PAYLOAD(msg),(int16_t) len);
#endif
}
...
#endif // end the airspeed library