...
#ifndef __mavlink_cam_cap_status__
#define __mavlink_cam_cap_status__

#define MAVLINK_MSG_ID_CAMERA_CAPTURE_STATUS 262u

#if defined(D_FT900)
typedef struct __mavlink_camera_capture_status_t MAVPACKED {
 uint32_t time_boot_ms;                                                         /*< [ms] Timestamp (time since system boot).*/
 float32_t image_interval;                                                      /*< [s] Image capture interval*/
...
#define MAVLINK_MSG_ID_CAMERA_CAPTURE_STATUS_LEN 18u
#define MAVLINK_MSG_ID_CAMERA_CAPTURE_STATUS_MIN_LEN 18u
#define MAVLINK_MSG_ID_262_LEN 18u
#define MAVLINK_MSG_ID_262_MIN_LEN 18u

#define MAVLINK_MSG_ID_CAMERA_CAPTURE_STATUS_CRC 12u
#define MAVLINK_MSG_ID_262_CRC 12u
 ...
 */
static inline uint16_t mavlink_msg_camera_capture_status_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg, uint32_t time_boot_ms, uint8_t image_status, uint8_t video_status, float32_t image_interval, uint32_t recording_time_ms, float32_t available_capacity)
{
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_camera_capture_status_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t chan, mavlink_message_t* msg, uint32_t time_boot_ms,uint8_t image_status,uint8_t video_status,float32_t image_interval,uint32_t recording_time_ms,float32_t available_capacity)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_CAMERA_CAPTURE_STATUS_LEN];
    _mav_put_uint32_t(buf, 0, time_boot_ms);
...
static inline void mavlink_msg_camera_capture_status_send(mavlink_channel_t chan, uint32_t time_boot_ms, uint8_t image_status, uint8_t video_status, float32_t image_interval, uint32_t recording_time_ms, float32_t available_capacity)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_CAMERA_CAPTURE_STATUS_LEN];
    _mav_put_uint32_t(buf, 0, time_boot_ms);
 ...
 */
static inline void mavlink_msg_camera_capture_status_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_boot_ms, uint8_t image_status, uint8_t video_status, float32_t image_interval, uint32_t recording_time_ms, float32_t available_capacity)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
{
    return _MAV_RETURN_uint8_t(msg,  17u);
}
...
{
    return _MAV_RETURN_float32_t(msg,  4u);
}
...
{
    return _MAV_RETURN_uint32_t(msg,  8u);
}
...
static inline void mavlink_msg_camera_capture_status_decode(const mavlink_message_t* msg, mavlink_camera_capture_status_t* camera_capture_status)
{
    ...
    memset(camera_capture_status, 0u, MAVLINK_MSG_ID_CAMERA_CAPTURE_STATUS_LEN);
    memcpy((void*) camera_capture_status,(void*) _MAV_PAYLOAD(msg),(int16_t) len);
#endif
}
