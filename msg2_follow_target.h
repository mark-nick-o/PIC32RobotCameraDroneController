#ifndef __cmd_follow_target_m2_mav__
#define __cmd_follow_target_m2_mav__
...
#define MAVLINK_MSG_ID_FOLLOW_TARGET 144u

#if defined(D_FT900)
typedef struct __mavlink_follow_target_t MAVPACKED {
 ...
 float32_t alt;                                                                 /*< [m] Altitude (MSL)*/
 float32_t vel[3u];                                                             /*< [m/s] target velocity (0,0,0) for unknown*/
 float32_t acc[3u];                                                             /*< [m/s/s] linear target acceleration (0,0,0) for unknown*/
 float32_t attitude_q[4u];                                                      /*<  (1 0 0 0 for unknown)*/
 float32_t rates[3u];                                                           /*<  (0 0 0 for unknown)*/
 float32_t position_cov[3u];                                                    /*<  eph epv*/
...
#define MAVLINK_MSG_ID_FOLLOW_TARGET_LEN 93u
#define MAVLINK_MSG_ID_FOLLOW_TARGET_MIN_LEN 93u
#define MAVLINK_MSG_ID_144_LEN 93u
#define MAVLINK_MSG_ID_144_MIN_LEN 93u

#define MAVLINK_MSG_ID_FOLLOW_TARGET_CRC 127u
#define MAVLINK_MSG_ID_144_CRC 127u

#define MAVLINK_MSG_FOLLOW_TARGET_FIELD_VEL_LEN 3u
#define MAVLINK_MSG_FOLLOW_TARGET_FIELD_ACC_LEN 3u
#define MAVLINK_MSG_FOLLOW_TARGET_FIELD_ATTITUDE_Q_LEN 4u
#define MAVLINK_MSG_FOLLOW_TARGET_FIELD_RATES_LEN 3u
#define MAVLINK_MSG_FOLLOW_TARGET_FIELD_POSITION_COV_LEN 3u
...
static inline uint16_t mavlink_msg_follow_target_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t timestamp, uint8_t est_capabilities, int32_t lat, int32_t lon,  float32_t alt, const  float32_t *vel, const  float32_t *acc, const  float32_t *attitude_q, const  float32_t *rates, const  float32_t *position_cov, uint64_t custom_state)
{
...
static inline void mavlink_msg_follow_target_send(mavlink_channel_t chan, uint64_t timestamp, uint8_t est_capabilities, int32_t lat, int32_t lon, float32_t alt, const float32_t *vel, const float32_t *acc, const float32_t *attitude_q, const float32_t *rates, const float32_t *position_cov, uint64_t custom_state)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_FOLLOW_TARGET_LEN];
    _mav_put_uint64_t(buf, 0, timestamp);
 ...
 */
static inline void mavlink_msg_follow_target_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t timestamp, uint8_t est_capabilities, int32_t lat, int32_t lon, float32_t alt, const float32_t *vel, const float32_t *acc, const float32_t *attitude_q, const float32_t *rates, const float32_t *position_cov, uint64_t custom_state)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
{
    return _MAV_RETURN_float32_t_array(msg, vel, 3,  28);
}
...
{
    return _MAV_RETURN_float32_t_array(msg, acc, 3,  40);
}
...
{
    return _MAV_RETURN_float32_t_array(msg, attitude_q, 4,  52);
}
...
{
    return _MAV_RETURN_float32_t_array(msg, rates, 3,  68);
}
...
{
    return _MAV_RETURN_float32_t_array(msg, position_cov, 3,  80);
}
...
static inline void mavlink_msg_follow_target_decode(const mavlink_message_t* msg, mavlink_follow_target_t* follow_target)
{
    ...
    memcpy((void*) follow_target,(void*) _MAV_PAYLOAD(msg),(int16_t) len);
#endif
}
