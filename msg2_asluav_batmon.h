#ifndef __mav2_asluav_battery_mon_
#define __mav2_asluav_battery_mon_
...
#define MAVLINK_MSG_ID_SENS_BATMON 209u

#if defined(D_FT900)
typedef struct __mavlink_sens_batmon_t MAVPACKED {
 uint64_t batmon_timestamp;                                                     /*< [us] Time since system start*/
 float32_t temperature;                                                         /*< [degC] Battery pack temperature*/
...
#define MAVLINK_MSG_ID_SENS_BATMON_LEN 41u
#define MAVLINK_MSG_ID_SENS_BATMON_MIN_LEN 41u
#define MAVLINK_MSG_ID_209_LEN 41u
#define MAVLINK_MSG_ID_209_MIN_LEN 41u

#define MAVLINK_MSG_ID_SENS_BATMON_CRC 155u
#define MAVLINK_MSG_ID_209_CRC 155u
...
static inline uint16_t mavlink_msg_sens_batmon_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t batmon_timestamp, float32_t temperature, uint16_t voltage, int16_t current, uint8_t SoC, uint16_t batterystatus, uint16_t serialnumber, uint32_t safetystatus, uint32_t operationstatus, uint16_t cellvoltage1, uint16_t cellvoltage2, uint16_t cellvoltage3, uint16_t cellvoltage4, uint16_t cellvoltage5, uint16_t cellvoltage6)
{
...
static inline void mavlink_msg_sens_batmon_send(mavlink_channel_t chan, uint64_t batmon_timestamp, float32_t temperature, uint16_t voltage, int16_t current, uint8_t SoC, uint16_t batterystatus, uint16_t serialnumber, uint32_t safetystatus, uint32_t operationstatus, uint16_t cellvoltage1, uint16_t cellvoltage2, uint16_t cellvoltage3, uint16_t cellvoltage4, uint16_t cellvoltage5, uint16_t cellvoltage6)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SENS_BATMON_LEN];
    _mav_put_uint64_t(buf, 0, batmon_timestamp);
 ...
 */
static inline float32_t mavlink_msg_sens_batmon_get_temperature(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_sens_batmon_decode(const mavlink_message_t* msg, mavlink_sens_batmon_t* sens_batmon)
{
    ...
    memset(sens_batmon, 0u, MAVLINK_MSG_ID_SENS_BATMON_LEN);
    memcpy((void*) sens_batmon,(void*) _MAV_PAYLOAD(msg),(int16_t) len);
#endif
}
...
#endif // end of battery monitor library