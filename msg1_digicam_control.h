#ifndef __mavlink2_digicam_command__
#define __mavlink2_digicam_command__
...
#define MAVLINK_MSG_ID_DIGICAM_CONTROL 155u

#if defined(D_FT900)
typedef struct __mavlink_digicam_control_t MAVPACKED {
 float32_t extra_value;                                                         /*<  Correspondent value to given extra_param.*/
...
#define MAVLINK_MSG_ID_DIGICAM_CONTROL_LEN 13u
#define MAVLINK_MSG_ID_DIGICAM_CONTROL_MIN_LEN 13u
#define MAVLINK_MSG_ID_155_LEN 13u
#define MAVLINK_MSG_ID_155_MIN_LEN 13u

#define MAVLINK_MSG_ID_DIGICAM_CONTROL_CRC 22u
#define MAVLINK_MSG_ID_155_CRC 22u
...
static inline uint16_t mavlink_msg_digicam_control_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target_system, uint8_t target_component, uint8_t session, uint8_t zoom_pos, int8_t zoom_step, uint8_t focus_lock, uint8_t shot, uint8_t command_id, uint8_t extra_param, float32_t extra_value)
{
...
static inline void mavlink_msg_digicam_control_send(mavlink_channel_t chan, uint8_t target_system, uint8_t target_component, uint8_t session, uint8_t zoom_pos, int8_t zoom_step, uint8_t focus_lock, uint8_t shot, uint8_t command_id, uint8_t extra_param, float32_t extra_value)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_DIGICAM_CONTROL_LEN];
    _mav_put_float(buf, 0, extra_value);
 ...
 */
static inline void mavlink_msg_digicam_control_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, uint8_t target_component, uint8_t session, uint8_t zoom_pos, int8_t zoom_step, uint8_t focus_lock, uint8_t shot, uint8_t command_id, uint8_t extra_param, float32_t extra_value)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
static inline void mavlink_msg_digicam_control_decode(const mavlink_message_t* msg, mavlink_digicam_control_t* digicam_control)
{
    ...
    memcpy((void*)digicam_control,(void*) _MAV_PAYLOAD(msg),(int16_t) len);
#endif
}
