#ifndef __mavlink1_msg_types
#define __mavlink1_msg_types
...
#define MAVLINK_EXTENDED_HEADER_LEN 14
   ...
   /* MicroChip PIC32 -- thisApplication --  */
  #define MAVLINK_MAX_EXTENDED_PACKET_LEN 2048U
#elif (defined _MSC_VER) || ((defined __APPLE__) && (defined __MACH__)) || (defined __linux__)
...
*/
#if !(MCU_NAME == PIC32MX795F512L)                                              // mikroE C for pic32 doesnt allow it
MAVPACKED(
...
typedef enum {
  ...
  MAV1_GET_PAY_LEN = 1u,
  MAV1_GET_SEQUENCE = 2u,
  MAV1_GET_SYSTEM = 3u,
  MAV1_GET_COMPONENT = 4u,
  MAV1_GET_MESSAGE = 5u,
  MAV1_PREAMBLE = 6u,
} mavlink1CollectState_e;                                                       /* mavlink1 collection states for the packet  */
...
#endif /* __cplusplus */
#endif  // end mavlink1 library types