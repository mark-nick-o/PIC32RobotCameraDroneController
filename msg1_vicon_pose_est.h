#ifndef __mav1_vicon_data_stream__
#define __mav1_vicon_data_stream__
...
#define MAVLINK_MSG_ID_VICON_POSITION_ESTIMATE_LEN 32u
#define MAVLINK_MSG_ID_VICON_POSITION_ESTIMATE_MIN_LEN 32u
#define MAVLINK_MSG_ID_104_LEN 32u
...
static inline uint16_t mavlink_msg_vicon_position_estimate_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t usec, float32_t x, float32_t y, float32_t z, float32_t roll, float32_t pitch, float32_t yaw)
{
...
static inline void mavlink_msg_vicon_position_estimate_send(mavlink_channel_t chan, uint64_t usec, float32_t x, float32_t y, float32_t z, float32_t roll, float32_t pitch, float32_t yaw)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_VICON_POSITION_ESTIMATE_LEN];
    _mav_put_uint64_t(buf, 0, usec);
 ...
 */
static inline void mavlink_msg_vicon_position_estimate_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t usec, float32_t x, float32_t y, float32_t z, float32_t roll, float32_t pitch, float32_t yaw)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline float32_t mavlink_msg_vicon_position_estimate_get_x(const mavlink_message_t* msg)
{
 ...
 */
static inline float32_t mavlink_msg_vicon_position_estimate_get_y(const mavlink_message_t* msg)
{
 ...
 */
static inline float32_t mavlink_msg_vicon_position_estimate_get_z(const mavlink_message_t* msg)
{
 ...
 */
static inline float32_t mavlink_msg_vicon_position_estimate_get_roll(const mavlink_message_t* msg)
{
 ...
 */
static inline float32_t mavlink_msg_vicon_position_estimate_get_pitch(const mavlink_message_t* msg)
{
 ...
 */
static inline float32_t mavlink_msg_vicon_position_estimate_get_yaw(const mavlink_message_t* msg)
{
