...
#define __NO_PACK                                                               // No pack is used for PIC32 to remove these if you want libraries from arduino project
#ifndef __NO_PACK
...
void SBGC_cmd_control_pack(SBGC_cmd_control_t &p, char Buf)
{
      memcpy(Buf, &p, sizeof(p));
      Buf[sizeof(p)] = '\0';
}

// Packs the mode control container as the payload buffer
