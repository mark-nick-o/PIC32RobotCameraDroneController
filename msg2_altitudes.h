#ifndef __altit_mavlink2__
#define __altit_mavlink2__
...
#define MAVLINK_MSG_ID_ALTITUDES 181u

#if defined(D_FT900)
typedef struct __mavlink_altitudes_t MAVPACKED {
...
#define MAVLINK_MSG_ID_ALTITUDES_LEN 28u
#define MAVLINK_MSG_ID_ALTITUDES_MIN_LEN 28u
#define MAVLINK_MSG_ID_181_LEN 28u
#define MAVLINK_MSG_ID_181_MIN_LEN 28u

#define MAVLINK_MSG_ID_ALTITUDES_CRC 55u
#define MAVLINK_MSG_ID_181_CRC 55u
...
static inline void mavlink_msg_altitudes_decode(const mavlink_message_t* msg, mavlink_altitudes_t* altitudes)
{
    ...
    memset(altitudes, 0u, MAVLINK_MSG_ID_ALTITUDES_LEN);
    memcpy((void*) altitudes,(void*) _MAV_PAYLOAD(msg),(int16_t) len);
#endif
}
