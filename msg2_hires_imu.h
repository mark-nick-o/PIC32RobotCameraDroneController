#ifndef __hires_IMU_mavlink2__
#define __hires_IMU_mavlink2__
...
#if defined(D_FT900)
typedef struct __mavlink_highres_imu_t MAVPACKED {
 uint64_t time_usec;                                                            /*< [us] Timestamp (UNIX Epoch time or time since system boot). The receiving end can infer timestamp format (since 1.1.1970 or since system boot) by checking for the magnitude the number.*/
 float32_t xacc;                                                                /*< [m/s/s] X acceleration*/
 float32_t yacc;                                                                /*< [m/s/s] Y acceleration*/
 float32_t zacc;                                                                /*< [m/s/s] Z acceleration*/
 float32_t xgyro;                                                               /*< [rad/s] Angular speed around X axis*/
 float32_t ygyro;                                                               /*< [rad/s] Angular speed around Y axis*/
 float32_t zgyro;                                                               /*< [rad/s] Angular speed around Z axis*/
 float32_t xmag;                                                                /*< [gauss] X Magnetic field*/
 float32_t ymag;                                                                /*< [gauss] Y Magnetic field*/
 float32_t zmag;                                                                /*< [gauss] Z Magnetic field*/
 float32_t abs_pressure;                                                        /*< [mbar] Absolute pressure*/
 float32_t diff_pressure;                                                       /*< [mbar] Differential pressure*/
 float32_t pressure_alt;                                                        /*<  Altitude calculated from pressure*/
 float32_t temperature;                                                         /*< [degC] Temperature*/
...
static inline uint16_t mavlink_msg_highres_imu_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t time_usec, float32_t xacc, float32_t yacc, float32_t zacc, float32_t xgyro, float32_t ygyro, float32_t zgyro, float32_t xmag, float32_t ymag, float32_t zmag, float32_t abs_pressure, float32_t diff_pressure, float32_t pressure_alt, float32_t temperature, uint16_t fields_updated, uint8_t id)
{
...
static inline void mavlink_msg_highres_imu_send(mavlink_channel_t chan, uint64_t time_usec, float32_t xacc, float32_t yacc, float32_t zacc, float32_t xgyro, float32_t ygyro, float32_t zgyro, float32_t xmag, float32_t ymag, float32_t zmag, float32_t abs_pressure, float32_t diff_pressure, float32_t pressure_alt, float32_t temperature, uint16_t fields_updated, uint8_t id)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_HIGHRES_IMU_LEN];
    _mav_put_uint64_t(buf, 0, time_usec);
 ...
 */
static inline void mavlink_msg_highres_imu_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint64_t time_usec, float32_t xacc, float32_t yacc, float32_t zacc, float32_t xgyro, float32_t ygyro, float32_t zgyro, float32_t xmag, float32_t ymag, float32_t zmag, float32_t abs_pressure, float32_t diff_pressure, float32_t pressure_alt, float32_t temperature, uint16_t fields_updated, uint8_t id)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline float32_t mavlink_msg_highres_imu_get_xacc(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float32_t(msg,  8);
}
 ...
 */
static inline float32_t mavlink_msg_highres_imu_get_yacc(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float32_t(msg,  12);
}
 ...
 */
static inline float32_t mavlink_msg_highres_imu_get_zacc(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float32_t(msg,  16);
}
 ...
 */
static inline float32_t mavlink_msg_highres_imu_get_xgyro(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float32_t(msg,  20);
}
 ...
 */
static inline float32_t mavlink_msg_highres_imu_get_ygyro(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float32_t(msg,  24);
}
 ...
 */
static inline float32_t mavlink_msg_highres_imu_get_zgyro(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float32_t(msg,  28);
}
 ...
 */
static inline float32_t mavlink_msg_highres_imu_get_xmag(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float32_t(msg,  32);
}
 ...
 */
static inline float32_t mavlink_msg_highres_imu_get_ymag(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float32_t(msg,  36);
}
 ...
 */
static inline float32_t mavlink_msg_highres_imu_get_zmag(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float32_t(msg,  40);
}
 ...
 */
static inline float32_t mavlink_msg_highres_imu_get_abs_pressure(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float32_t(msg,  44);
}
 ...
 */
static inline float32_t mavlink_msg_highres_imu_get_diff_pressure(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float32_t(msg,  48);
}
 ...
 */
static inline float32_t mavlink_msg_highres_imu_get_pressure_alt(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float32_t(msg,  52);
}
 ...
 */
static inline float32_t mavlink_msg_highres_imu_get_temperature(const mavlink_message_t* msg)
{
    return _MAV_RETURN_float32_t(msg,  56);
}
...
static inline void mavlink_msg_highres_imu_decode(const mavlink_message_t* msg, mavlink_highres_imu_t* highres_imu)
{
    ...
    memset(highres_imu, 0u, MAVLINK_MSG_ID_HIGHRES_IMU_LEN);
    memcpy((void*) highres_imu,(void*) _MAV_PAYLOAD(msg),(int16_t) len);
#endif
}
...
#endif // high resolution IMU data messaging library